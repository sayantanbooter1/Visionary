...
import CreateVisionaryAccount from "./components/CreateVisionaryAccount"
...
export default function SignUpPage() {
  ...
  // Clear the signup store when component mounts
  useEffect(() => {
    resetForm()
    console.log("SignUp store cleared on page load")
  }, [resetForm])
  ...
  if (showEmailSignUp) {
    return <CreateVisionaryAccount onBack={() => setShowEmailSignUp(false)} />
  }

  if (showMobileSignUp) {
    return <MobileSignUp onBack={() => setShowMobileSignUp(false)} />
  }
          ...
          >
            ...
            <div className="hidden lg:block" style={{ padding: '72px 42px 48px 42px' }}>
              <div className="grid grid-cols-2 items-center" style={{ gap: '64px' }}>
                ...
                <div className="flex flex-col justify-between h-full">
                  ...
                  <div>
                    <Link href="/signin" className="text-blue-600 hover:text-blue-700 font-medium text-base">
            ...
            <div className="lg:hidden p-6 sm:p-8">
              <div className="flex flex-col items-center text-center space-y-8">
                ...
                {/* Bottom section - Already have account and Terms */}
