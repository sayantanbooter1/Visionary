...
export default function Teacher({ onBack }: TeacherProps) {
        ...
        <div className="bg-white rounded-3xl border border-gray-200 p-12 md:p-16 shadow-lg min-h-[500px] flex flex-col items-center justify-center flex-1">
          ...
          <div className="w-full max-w-lg space-y-6">
            ...
            <Button
              ...
              disabled={(!fullName || !subject || !experience) || isSubmitting}
              className={`w-full rounded-full py-6 text-base font-medium mt-8 transition-colors flex items-center justify-center gap-2 ${(!fullName || !subject || !experience) || isSubmitting
